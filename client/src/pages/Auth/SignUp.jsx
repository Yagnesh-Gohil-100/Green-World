...
import { useAuth } from "../../contexts/AuthContext";   // ✅ add auth
...
const SignUp = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(url, final_form_data);

      if (response.data.success) {
        alert("Signup Successful!", response.data.userType);
        // ✅ log in user immediately after signup
        await login(response.data.token, response.data.data, response.data.userType);
